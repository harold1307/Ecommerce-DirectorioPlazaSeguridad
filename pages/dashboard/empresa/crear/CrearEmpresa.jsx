            ...
            <Col  xs={{span: 24, offset: 0,}}  sm={{span: 24, offset: 1,}}  md={{span: 22,offset: 2,}}  lg={{span: 18,offset: 4,}}  xl={{span: 18,offset: 4,}} >                
                    ...
                    <div className='formulariocrearEmpresa'>
                        ...
                        >   
                            ...
                            <div className='pb-2'>
                                <h6 className="title">Cargando Logo</h6>                                                                         
                                <p>Ingrese el logo de la empresa</p>
                                </div>
                            ...
                            <div className='pb-2'>
                                        <h6 className="title mb-5">Creando empresa.</h6>                                                                         
                                    
                                    <Spin tip="Cargando...">
                                        <Alert
                                        message="Guardando imagenes.."
                                        description="No se desconecte, se está creando la empresa..."
                                        type="info"
                                        />
                                    </Spin>
                                </div>
