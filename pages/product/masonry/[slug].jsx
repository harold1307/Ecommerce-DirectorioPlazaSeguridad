...
import GalleryMasonry from '~/components/partials/products/gallery/gallery-masonry';
import DetailOne from '~/components/partials/products/details/detail-one';
import InfoThree from '~/components/partials/products/info-tabs/info-three';
