                                                        ...
                                                        [].map( ( item, index ) =>
                                                            <tr key={ index }>
                                                                <td className="product-col">
                                                                    <div className="product">
                                                                        ...
                                                                        <h4 className="product-title">
                                                                            <ALink href={ `/product/default/${item.slug}` }>Nombre</ALink>
                                                                        </h4>
                                                                    </div>
                                                                </td>
                                                                ...
                                                                <td className="quantity-col">
                                                                    <Qty value='5' changeQty={ current => changeQty( current, index ) } adClass="cart-product-quantity"></Qty>
                                                                </td>

                                                                <td className="total-col">
                                                                    ${ '5'.toLocaleString( undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 } ) }
                                                                </td>
